package com.java.learners.methods;
...
class Test {
    ...
    // that is created inside another class 'MethodDemo02'.
    ...
    public int m1() {
        System.out.println("Inside the method m1 by object of MethodDemo02 class");
